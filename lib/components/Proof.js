...
class Proof {
  constructor(web3) {
    ...
    this.publicKey = this.web3.utils.toChecksumAddress(process.env.WEB3_PUBLIC_KEY)
  ...
  //     Balance: ${web3.ipc.utils.fromWei(this.balance, 'ether')} ETH
  //     Nonce: ${this.nonce}
  //     `
  //   )
  // }
  ...
  //      this.wallet = await this.web3.eth.accounts.wallet.add(this.privateKey)
  //      resolve()
  //   })
  // }
  //
  // updateNonce() {
  //   return new Promise(async(resolve, reject) => {
  //     this.nonce = await this.web3.eth.getTransactionCount(this.wallet.address, 'pending'),
  //     resolve()
  //   })
  // }
  //
  // updateBalace() {
  //   return new Promise(async(resolve, reject) => {
  //     this.balance = await this.web3.eth.getBalance(this.wallet.address);
  //     resolve()
  //   })
  // }
